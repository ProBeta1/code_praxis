...
function Dpproblemset() {
  ...
  const getstringsProblems = async () => {
    let res = await stringsService.getAll();
    setstrings(res);
  }
  ...
  const renderstringsProblem = stringsproblem => {
    return (
      <tr>
       <td>{stringsproblem.name}</td>
       <td>{stringsproblem.index}</td>
  ...
  return (
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Strings Questions</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Strings Questions</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap table-striped ">
                  ...
                  {(strings && strings.length > 0) ? (
                   strings.map(stringsproblem => renderstringsProblem(stringsproblem)))
                   : (
