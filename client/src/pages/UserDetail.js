  ...
  return (
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
         <div class="image">
          <img src={avatar} class="img-circle elevation-2" alt="image" style={{width : 180, height: 180, padding : 10}}></img>
          </div>
          <Link to="/dashboard" class="d-block" style={{fontSize: 40,textAlign: "center", fontWeight: 40}}>{handle}</Link>
          <Link to="/dashboard" class="d-block" style={{fontSize: 20,textAlign: "center", fontWeight: 20}}>{name}</Link>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="header" style ={{padding: 20}}>
          <h1 class="title" style={{fontSize: 30}}>PROFILE DETAILS</h1>
          <p class="category"></p>
        </div>
        <div class="content">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input placeholder="your name" disabled type="text" class="form-control" value={name} style={{width: 320}}></input>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input placeholder="your rating" disabled type="text" class="form-control" value={rating} style={{width: 320}}></input>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input placeholder="your rank" disabled type="text" class="form-control" value={rank} style={{width: 320}}></input>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input placeholder="max rating" disabled type="text" class="form-control" value={maxRating} style={{width: 320}}></input>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input placeholder="max rank" disabled type="text" class="form-control" value={maxRank} style={{width: 320}}></input>
                </div>
              </div>
            </div>
          </form>
                ...
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo1" id="todoCheck1"></input>
                  ...
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo2" id="todoCheck2" checked></input>
                  ...
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo3" id="todoCheck3"></input>
                  ...
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo5" id="todoCheck5"></input>
                  ...
                  <li>
                    ...
                    <div  class="icheck-primary d-inline ml-2">
                      <input type="checkbox" value="" name="todo6" id="todoCheck6"></input>
